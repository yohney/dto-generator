//------------------------------------------------------------------------------
// <copyright file="GenerateDtoCommandPackage.cs" company="Company">
...
namespace DtoGenerator.Vsix
{
    ...
    {
        /// <summary>
        /// GenerateDtoCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "1a6326a1-4c14-440b-a311-870791acd62e";

        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDtoCommand"/> class.
        /// </summary>
        public GenerateDtoCommandPackage()
        {
        ...
        {
            GenerateDtoCommand.Initialize(this);
            base.Initialize();
        }
